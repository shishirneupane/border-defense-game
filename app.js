...
background.src = "img/desert.webp";
...
function drawEnemies() {
  if (frame % enemiesInterval === 0) {
    let verticalPosition = Math.floor(Math.random() * 9) * CELL_SIZE;
...
function showGameOver() {
  if (gameOver) {
    ...
    ctx.fillText("GAME OVER", 700, 450);
    // ctx.fillStyle = 'black';
    ctx.font = "30px Fira Code";
    ctx.fillText(`You killed ${killedEnemies} enemies!`, 700, 500);
  }
}
